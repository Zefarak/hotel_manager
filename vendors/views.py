...
from .forms import VendorForm, InvoiceVendorDetailForm, EmployerForm, PaymentForm, NoteForm, Payment
...
class CreateVendorView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["page_title"], context['back_url'],  = 'Δημιουργια Προμηθευτη', reverse('vendors:list')
